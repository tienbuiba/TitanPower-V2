...
import MainInterconnectionProduct from '../components/main/MainInterconnectionProduct';

const theme = createTheme();

export default function InterconnectionProduct() {
  return (
